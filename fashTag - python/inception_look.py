# -*- coding: utf-8 -*-
# annaconda prompt에서 activate 후 소스코드 경로로 들어간 후
# python inceptionv3_retrain.py --image_dir ./path 를 입력하여 학습시킨다.
...
def get_random_distorted_bottlenecks(
    sess, image_lists, how_many, category, imㅋage_dir, input_jpeg_tensor,
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/tmp1/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/tmp1/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/tmp1/retrain_logs',
