...
def runDemo():
    ...
    for imageName in imageNames:
        ...
        imglib.img.thumbnail(size, Image.ANTIALIAS)
        imglib.setBBXs(bbox, 'person')
        imglib.drawBox(0.999)

        area = imglib.cutArea(0.999)
        resultimg = imglib.img.crop(area)
        resultimg.save(resultsDir + '/' + imageName[1] + '.jpg')
